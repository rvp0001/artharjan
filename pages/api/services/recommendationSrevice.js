...
const  sendRecommendationNotification =async (_parent,{ recommendation} ,context )=>
{
 ...
 let subscriptions= await subscriptionservices.subscriptions({applicationid ,
  ...
  async (_parent,dataJSON,context) => {
  ...
  const recommendations = async (_parent,args, context) => {
